...
import com.example.hopital1.adapter.MsgAdapter;
...
public class add_mesg extends AppCompatActivity {
    private ImageButton sendMessage;
    private EditText userMessageInput;

    private RecyclerView recyclerView;
    private MsgAdapter groupAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usersRefs =FirebaseDatabase.getInstance().getReferenceFromUrl("https://hospital-system-e9e0f-default-rtdb.firebaseio.com/").child("users");
        ...
        groupAdapter=new MsgAdapter(getApplicationContext(),groupLists);
        ...
        sendMessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                GetUserInfo();
                Toast.makeText(getApplicationContext(), "Rachiiiid", Toast.LENGTH_SHORT).show();
